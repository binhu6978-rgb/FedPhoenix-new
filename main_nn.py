...
def save_model(data, ylabel, args):
    ...
    file = '{}_central_{}_{}_{}_lr_{}_{}_frac_{}.txt'.format(args.dataset, args.model,
...
if __name__ == '__main__':
    ...
    if args.model == 'cnn' and args.dataset == 'cifar':
        ...
        net_glob = ResNet18_cifar10(num_classes = args.num_classes).to(args.device)
    ...
    for epoch in range(args.epochs):
        ...
        if epoch % 30==29:
            #test_acc, test_loss = test(net_glob, test_loader)
            save_model(net_glob.state_dict(), f"model_{epoch}Epoch", args)
    # plot loss
    plt.figure()
